...
filewrite('zatvorky.tex', 'Závorky a zlomky', prikladyLoad,
          ...
          prikladyFontsize=r'\normalsize', rieseniaFontsize=r'\scriptsize', tightLayoutRies=0.1, nicefracSolution=False, tabulkyBraille=True)
